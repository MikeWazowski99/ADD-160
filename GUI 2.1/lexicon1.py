...
entry_address = tk.Text(frame_entry, width=30, height=3)
label_address.grid(row=4, column=0, sticky='nw', pady=2)
...
def display_info():
    ...
    address = entry_address.get("1.0", tk.END).strip()  # Get all text from Text widget
